...
RSpec.describe Truelist::Client do
  ...
  describe "error handling" do
    context "with raise_on_error disabled (default)" do
      ...
      it "returns unknown on 500 error" do
        stub_request(:post, api_url)
      ...
      it "returns unknown on 429 rate limit" do
        stub_request(:post, api_url)
      ...
      it "returns unknown on 401 authentication error" do
        stub_request(:post, api_url)
      ...
      it "returns unknown on malformed JSON" do
        stub_request(:post, api_url)
